      ...
      <Container id="about" style={{ paddingTop: '5rem', paddingBottom: '5rem' }}>
        <Row>
          <Col className="p-5 shadow-sm">
            ...
            <p>
              Justin has experience in building, developing and deploying to production web applications that improve usability and enhance performance for the company. He has a strong background in a variety of web technologies with a focus on Front End. Justin is passionate about the application of new technologies in Artificial Intelligence (AI) and implementing the emerging technologies into web applications.
            </p>
          </Col>
        </Row>
      </Container>
